...
var predefinedGuesses = [1, 8, 9, 10, 11, 15, 20, 25, 28, 29, 35, 40, 44, 41, 45, 50];
while (!guessStatus) {
    for (var _i = 0, predefinedGuesses_1 = predefinedGuesses; _i < predefinedGuesses_1.length; _i++) {
        var iterator = predefinedGuesses_1[_i];
        if (iterator === randomNumber) {
            console.log("you guessed it right");
            console.log("Your guess: ".concat(iterator, "\n The Random number: ").concat(randomNumber));
            guessStatus = true;
            break;
        }
